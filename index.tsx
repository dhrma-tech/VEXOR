...
// Initialize Gemini API - Safe check for missing key in static hosting environment
const apiKey = process.env.API_KEY || ''; 
// We initialize the client, but calls will fail if key is empty. 
// Ideally, we would delay initialization until we have the key, but for this structure:
